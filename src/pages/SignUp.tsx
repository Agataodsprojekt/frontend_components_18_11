...
const SignUp = () => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    // For now, redirect to viewer after sign up
    navigate("/viewer");
  };
      ...
      <div className="w-2/3 bg-gray-50 flex flex-col justify-center items-center p-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-between items-center gap-4 mb-8">
            ...
            <Link to="/signin" className="text-sm text-gray-600 hover:text-gray-900 whitespace-nowrap">
              Already a member? <span className="font-medium text-blue-600 hover:text-blue-700">Sign in</span>
            </Link>
          </div>

          <p className="text-gray-600 mb-6">Sign up using your account</p>

          {/* Social Sign Up */}
          <div className="flex gap-4 mb-8">
            <button className="flex-1 border border-gray-300 rounded-lg py-3 font-medium text-gray-700 hover:bg-gray-50 transition-colors">
              Google
            </button>
            <button className="flex-1 border border-gray-300 rounded-lg py-3 font-medium text-gray-700 hover:bg-gray-50 transition-colors">
              Apple
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-50 text-gray-500">Or sign up with your email</span>
            </div>
          </div>
